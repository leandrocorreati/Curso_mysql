...
select nome, descricao,ano from cursos where ano != '2015' order by nome, ano;
...
select nome,carga from cursos where carga > 35 and totaulas < 30;

select nome,carga from cursos where carga > 35 or totaulas < 30;